...
<div class="wrap">
	...
	<form method="post">
		...
		<input type="hidden" name="tsa_zone_action" value="<?php echo esc_attr( $action ); ?>">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<select id="tsa-zone-location" name="location">

						<option value="sidebar" <?php selected( $location, 'sidebar' ); ?>>
							<?php esc_html_e( 'Sidebar', 'trade-sphare-ads' ); ?>
						</option>

						<option value="top" <?php selected( $location, 'top' ); ?>>
							<?php esc_html_e( 'Top of Article', 'trade-sphare-ads' ); ?>
						</option>

						<option value="middle" <?php selected( $location, 'middle' ); ?>>
							<?php esc_html_e( 'Middle of Article', 'trade-sphare-ads' ); ?>
						</option>

						<option value="bottom" <?php selected( $location, 'bottom' ); ?>>
			...
			<tr>
				...
				<td>
					<select id="tsa-zone-pricing" name="pricing_type">

						<option value="monthly" <?php selected( $pricing_type, 'monthly' ); ?>>
							<?php esc_html_e( 'Monthly', 'trade-sphare-ads' ); ?>
						</option>

						<option value="daily" <?php selected( $pricing_type, 'daily' ); ?>>
			...
			<tr>
				...
				<td>
					<select id="tsa-zone-status" name="status">
